...
### Huntsman
Huntsman soll sich damit beschäftigen bestehende Infrastruktur in einem Ansible Inventory zu organisieren. Management hosts sollen errichtet und verwaltet werden. Das Reale Problem des IT Wildwuchs soll verstanden und durch Ansible behoben werden. Es ist ein gut organisiertes Inventar zu führen und gezielt playbooks auf bestehende Hostgruppen anzuwenden. Ein Namenskonzept soll entwickelt und angewandt werden. Huntsman nehmen eine ordnende Rolle ein. Sie fangen den Wildwuchs der Rabbits ein.
